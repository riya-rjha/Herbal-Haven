...
function Card({ titles }) {
  return (
    <>
      <div className="p-5 bg-white  sm:w-[300px] md:w-[370px] lg:w-[370px] h-auto rounded overflow-hidden shadow-lg mt-4 transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
        <img
